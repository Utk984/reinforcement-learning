...
gym.register(
    ...
    kwargs={
        ...
        "sb3_cfg_entry_point": agents.sb3_ppo_cfg,
        "sb3_sac_cfg_entry_point": agents.sb3_sac_cfg,
    },
...
# SAC versions
gym.register(
    id="Isaac-Handover-Block-Dual-PSM-SAC-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": joint_pos_env_cfg.BlockHandoverEnvCfg,
        # "rsl_rl_cfg_entry_point": agents.sac_rl_cfg.HandoverBlockSACRunnerCfg,
        "rsl_rl_cfg_entry_point": agents.rsl_rl_sac_cfg.HandoverBlockSACRunnerCfg,
    },
    disable_env_checker=True,
)

gym.register(
    id="Isaac-Handover-Block-Dual-PSM-SAC-Play-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": joint_pos_env_cfg.BlockHandoverEnvCfg_PLAY,
        "rsl_rl_cfg_entry_point": agents.rsl_rl_sac_cfg.HandoverBlockSACRunnerCfg,
...
# SAC IK Absolute control versions
gym.register(
    id="Isaac-Handover-Block-Dual-PSM-IK-Abs-SAC-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": ik_abs_env_cfg.BlockHandoverEnvCfg,
        "rsl_rl_cfg_entry_point": agents.rsl_rl_sac_cfg.HandoverBlockSACRunnerCfg,
...
gym.register(
    id="Isaac-Handover-Block-Dual-PSM-IK-Abs-SAC-Play-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": ik_abs_env_cfg.BlockHandoverEnvCfg_PLAY,
        "rsl_rl_cfg_entry_point": agents.rsl_rl_sac_cfg.HandoverBlockSACRunnerCfg,
...
# SAC IK Relative control versions
gym.register(
    id="Isaac-Handover-Block-Dual-PSM-IK-Rel-SAC-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": ik_rel_env_cfg.BlockHandoverEnvCfg,
        "rsl_rl_cfg_entry_point": agents.rsl_rl_sac_cfg.HandoverBlockSACRunnerCfg,
...
gym.register(
    id="Isaac-Handover-Block-Dual-PSM-IK-Rel-SAC-Play-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": ik_rel_env_cfg.BlockHandoverEnvCfg_PLAY,
        "rsl_rl_cfg_entry_point": agents.rsl_rl_sac_cfg.HandoverBlockSACRunnerCfg,
