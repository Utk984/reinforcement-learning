...
def main():
    ...
    if args_cli.max_iterations:
        agent_cfg["n_timesteps"] = args_cli.max_iterations * agent_cfg["train_freq"] * env_cfg.scene.num_envs

    # directory for logging into
    log_dir = os.path.join("logs", "sb3", args_cli.task + "_sac", datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
    ...
    agent = SAC(policy_arch, env, **agent_cfg)
